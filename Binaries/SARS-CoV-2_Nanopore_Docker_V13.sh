...
if [ ${1} == "MidnightV3" ]; then
	primer_schemes=/home/docker/CommonFiles/artic-ncov2019/primer_schemes
	schemes_sample=nCoV-2019/V9.3
	SpikeRef=/home/docker/CommonFiles/artic-ncov2019/primer_schemes/nCoV-2019/V9.3/nCoV-2019.spike.fa
	min=500
	max=1800
	cp /home/docker/CommonFiles/artic-ncov2019/primer_schemes/nCoV-2019/V9.3/nCoV-2019.bed /home/docker/Fastq/primers.bed
...
if [ ${1} == "ArticV5" ]; then
	primer_schemes=/home/docker/CommonFiles/artic-ncov2019/primer_schemes
	schemes_sample=nCoV-2019/V5.4.2
	SpikeRef=/home/docker/CommonFiles/artic-ncov2019/primer_schemes/nCoV-2019/V5.4.2/nCoV-2019.spike.fa
	min=200
	max=700
	cp /home/docker/CommonFiles/artic-ncov2019/primer_schemes/nCoV-2019/V5.4.2/nCoV-2019.primer.bed /home/docker/Fastq/primers.bed
fi
...
do
	...
	artic minion --medaka --medaka-model r1041_e82_400bps_sup_v4.2.0 --normalise 200 --threads 8 --scheme-directory ${primer_schemes} --read-file ${dir%/}_.fastq --sequencing-summary ${basedir}/${summary} ${schemes_sample} ${dir%/}
...
nextclade run --input-dataset /home/docker/nc_sars-cov-2 --output-csv=nextcladenew/${runname}_Nextclade.new.results.csv nextcladenew/${runname}.fa
